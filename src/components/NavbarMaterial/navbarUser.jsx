    ...
    return (<div className={classes.sectionDesktop}>
        ...
        <List className={classes.list}>
            ...
            <Link className={classes.link} to="/home">
              ...
              <ListItem>
              <Link className={classes.link} to="/bookings-user">
                  bOOKINGS
...
{(seen && seen.length != 0 && clicked==false) ? <span className="badge badge-primary badge-pill">{seen.length}</span> : null}
              ...
              <Link className={classes.link} to="/logout">
               ...
               <Link to="/profileuser" className={classes.link}> <Avatar aria-label="Profile Pic"  src={img} className='ml-2 mt-3' >


{user.firstname}  </Avatar>{user.firstname}   </Link> 
              </List></div>  );
}
